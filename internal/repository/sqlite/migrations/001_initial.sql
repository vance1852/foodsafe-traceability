...
CREATE TABLE food_facilities (
    ...
    organization_id TEXT NOT NULL REFERENCES organizations(id),
    name TEXT NOT NULL,
    kind TEXT NOT NULL CHECK (kind IN ('processing_plant','distribution_center','cold_storage')),
...
CREATE INDEX idx_sources_org_active ON food_facilities(organization_id, active);
