...
func TestSourceAndZoneValidation(t *testing.T) {
	valid := FoodFacility{OrganizationID: "o1", Name: "North Foods Plant", Kind: FacilityProcessing, Timezone: "Asia/Shanghai"}
	if err := valid.Validate(); err != nil {
		t.Fatalf("valid source rejected: %v", err)
	}
	invalidSources := []FoodFacility{
		{Name: "North Foods Plant", Kind: FacilityProcessing, Timezone: "UTC"},
		{OrganizationID: "o1", Name: "x", Kind: FacilityProcessing, Timezone: "UTC"},
		{OrganizationID: "o1", Name: "North Foods Plant", Kind: "lake", Timezone: "UTC"},
		{OrganizationID: "o1", Name: "North Foods Plant", Kind: FacilityProcessing, Timezone: "Mars/Base"},
	}
